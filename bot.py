...
explicit_data4 = {'cunt', 'mur', 'pussy', 'sex', 'pis', 'frick', 'nigga', 'nazi', 'sht', 'sh*t', 'rape', 'crap', 'n*gger', 'xxx', 'neo', 'rupe', 'naz*', 'dam', 'asre', 'dummy', 'th*t', 'fort', 'thot', 'fk', 'prod', 'v*gina', 'pok', 'gay', 'lmb', 'peg', 'hac', 'geno', 'dayum', 'hit', 'job', 'n!gger', 'p*rn', 'flip', 'p*ss', 'idoit', 'damn', 'p*ssy', 'dump', 'date', 'nigger', 'p!s', 'fck', 'sta', 'crud', 'segs', 'shit', 'c!ck', 's*ck', 'bastard', 'kil', 'fuc', 'porn', 'cu', 't!t', 'tit', 'fack', 'sh!t', 'butt', 'danm', 'dip', 's*x', 'd!ck', 'gai', 'idit', 'cock', 'fuke', 'puss', 'trash', 'slap', 'seggs', 'anal', 'sx', 'fac', 'idiot', 'c*nt', 'stup', 'fr*ck', 'n!gga', 'rob', 'mutil', 'dumb', 't*t', 'stfu', 'clusterfuc', 'blo', 'hitler', 'lana', 'rod', 'fuk', 'nite', 'suck', 'fuck', 'btch', 'lma', 'pus', 'p!ss', 'idg', 'cr*p', 'n*zi', 'robl', 'piss', 'shut', 'ass', 'bitch', 'fu', 'prn', 'arse', 'stick', 'fruck', 'suc', 'bang', 'dum', 'vagina', 'come', 'dick'}
explicit_data3 = {'nazi', 'd!ck', 'slap', 'bitch', 'stick', 'idoit', 'vagina', 'cunt', 'hac', 'dip', 'pis', 'dumb', 'dam', 'sex', 'dick', 'fruck', 'prn', 'dump', 'stfu', 'rod', 'blo', 'p!ss', 'suc', 'dummy', 'hit', 'n!gga', 'anal', 'rape', 'fuc', 'fac', 'geno', 'fu', 'rob', 'robl', 'suck', 'sta', 'fack', 'damn', 'cock', 't!t', 'crap', 'fuke', 'lmb', 'lma', 'date', 'dum', 'nite', 'dayum', 'fck', 'btch', 'seggs', 'kil', 'shit', 'lana', 'shut', 'flip', 'ass', 'come', 'butt', 'arse', 'gai', 'c!ck', 'fuck', 'pok', 'gay', 'xxx', 'fort', 'clusterfuc', 'puss', 'idg', 'mutil', 'sht', 'piss', 'frick', 'stup', 'prod', 'bang', 'sx', 'idit', 'nigger', 'rupe', 'danm', 'fk', 'pussy', 'asre', 'peg', 'pus', 'neo', 'mur', 'trash', 'p!s', 'hitler', 'idiot', 'tit', 'thot', 'segs', 'sh!t', 'nigga', 'job', 'bastard', 'fuk', 'n!gger', 'porn', 'cu', 'crud'}
explicit_data2 = {'cock', 'vagina', 'sex', 'anal', 'fuck', 'shit', 'nigga', 'piss', 'cunt', 'pussy', 'dick', 'nigger'}
filter5 = {'1', '2', '3', '4', '5', '6', '7', '8', '9', '0', 'a', 'e', 'u', 'i', 'o', 'y', '!', '@', '#', '$', '%', '^', '&', '*', '(', ')'}
filter4 = {'!', '@', '#', '$', '%', '&', '*'}
...
greetings = ('Hello', 'Nice to see you', 'Welcome', 'Hi', 'Hey there', 'Bonjour', 'Hi there')
...
async def on_member_join(member, ctx):
    await ctx.send(f'User joined.')
    await ctx.send(':wave:')


@client.event
async def on_member_remove(ctx, *, member : discord.member):
    await ctx.send(f'{member.display_name} left.')
    await ctx.send(':wave:')
...
async def warn(ctx, member : discord.Member, *, reason):
    with open('Warns.txt', 'a') as file:
        file = file.write('**{member.mention}** you were warned by **{ctx.author}**:**{reason}**\n')
...
async def fetch_member_history(ctx, member : discord.Member, channel : discord.TextChannel, limit=10):
    ...
    async for message in (channel.history(limit=limit)):
        if message.author == member:
            messages.insert(0, f'https://discord.com/channels/{ctx.guild.id}/{message.channel.id}/{message.id}')
...
async def fetch_channels(ctx, link=False):
    ...
    for i in ctx.guild.channels:
        if link:
            channels.insert(0, f'https://discord.com/channels/{ctx.guild.id}/{i.id}')
        else:
...
async def fetch_code(ctx):
    await ctx.send('https://github.com/HRLO77/HRLO77-test-bot---Source-code')
